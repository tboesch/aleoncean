 ...
 */
public class RemoteDeviceEEPA50601EltakoFAH60Test {
    ...
    public void testCreateThroughFactory() {
        ...
        assertTrue(DeviceFactory.isTypeSupported("RD_A5-06-01_EltakoFAH60"));

        final StandardDevice factoryDevice = DeviceFactory.createFromType("RD_A5-06-01_EltakoFAH60", null, null, null);

        assertTrue(factoryDevice instanceof RemoteDeviceEEPA50601EltakoFAH60);
